...
export const LanguageFocusSection: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto pb-48 space-y-16 px-2">
      ...
      <section className="relative">
         <div className="flex items-center gap-3 mb-6 px-4">
             ...
             <h3 className="text-3xl font-black text-gray-700">Giving Reasons (因為...)</h3>
         </div>

         <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border-[6px] border-pink-100 relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-pink-50 rounded-full"></div>

            <p className="text-2xl text-gray-600 font-bold text-center mb-10 leading-relaxed relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 relative z-10">
                ...
                <div className="bg-blue-50 border-4 border-blue-200 p-6 rounded-[2rem] w-full md:w-1/3 text-center shadow-md relative group hover:-translate-y-1 transition-transform">
                    ...
                    <p className="text-2xl font-black text-blue-800 leading-tight">I want to go to the farm</p>
                ...
                <div className="flex flex-col items-center justify-center h-full gap-1">
                    <div className="bg-pink-500 text-white px-6 py-3 rounded-2xl font-black text-xl shadow-[0_4px_0_0_rgba(190,24,93,1)] z-20 animate-pulse">
                        because
                    </div>
                    {/* Dashed line connecting */}
                    <div className="w-1 h-12 md:w-16 md:h-1 border-l-4 md:border-l-0 md:border-t-4 border-dashed border-gray-300"></div>
                </div>
                ...
                <div className="bg-green-50 border-4 border-green-200 p-6 rounded-[2rem] w-full md:w-1/3 text-center shadow-md relative group hover:-translate-y-1 transition-transform">
                    <div className="text-6xl mb-2 group-hover:scale-110 transition-transform">🐮</div>
                    <p className="text-2xl font-black text-green-800 leading-tight">I want to feed animals</p>
      ...
      <section className="relative">
         <div className="flex items-center gap-3 mb-6 px-4">
             ...
             <h3 className="text-3xl font-black text-gray-700">Order of Events (順序)</h3>
         </div>

         <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl border-[6px] border-indigo-100 relative">
             <div className="relative space-y-8">
                 ...
                 <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                     ...
                     <div className="bg-indigo-50 p-6 rounded-[2rem] flex-1 w-full border-4 border-white shadow-md flex items-center gap-4 hover:scale-[1.02] transition-transform">
                         <div className="text-5xl">🏰</div>
                         <div>
                            <p className="text-2xl font-bold text-indigo-900">I want to build a sandcastle.</p>
                            <p className="text-indigo-400 font-bold">首先...</p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                     ...
                     <div className="bg-sky-50 p-6 rounded-[2rem] flex-1 w-full border-4 border-white shadow-md flex items-center gap-4 hover:scale-[1.02] transition-transform">
                         <div className="text-5xl">🐚</div>
                         <div>
                            <p className="text-2xl font-bold text-sky-900">I want to look at shells.</p>
                            <p className="text-sky-400 font-bold">然後...</p>
                         </div>
                     </div>
                 </div>
                 ...
                 <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center">
                     ...
                     <div className="bg-fuchsia-50 p-6 rounded-[2rem] flex-1 w-full border-4 border-white shadow-md flex items-center gap-4 hover:scale-[1.02] transition-transform">
                         <div className="text-5xl">🧺</div>
                         <div>
                            <p className="text-2xl font-bold text-fuchsia-900">I want to have a picnic.</p>
                            <p className="text-fuchsia-400 font-bold">最後...</p>
                         </div>
                     </div>
                 </div>
             </div>
      ...
      <section className="pt-8">
         <div className="bg-yellow-50 rounded-[3rem] p-8 md:p-12 border-[6px] border-yellow-300 shadow-xl relative text-center overflow-hidden">
            ...
            <div className="inline-block bg-white text-yellow-600 px-10 py-3 rounded-full font-black text-2xl mb-8 shadow-md border-2 border-yellow-200 transform -rotate-2">
                Mini Quiz ✏️
            </div>

            <div className="bg-white rounded-[2.5rem] p-10 mb-8 shadow-sm border-4 border-yellow-100 relative min-h-[160px] flex items-center justify-center">
                ...
                {showFeedback === 'correct' && (
                    <div className="absolute inset-0 flex items-center justify-center bg-white/60 backdrop-blur-[2px] rounded-[2.3rem] z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 relative z-10">
                {quizQuestions[quizIndex].options.map((opt) => (
                    <button
                        ...
                        className="bg-white border-b-[5px] border-yellow-200 text-yellow-800 px-8 py-4 rounded-2xl text-xl font-black hover:bg-yellow-50 hover:border-yellow-300 hover:-translate-y-1 active:border-b-0 active:translate-y-2 transition-all shadow-sm min-w-[150px]"
                    >
                        {opt}
                    </button>
                ))}
            ...
            <div className="mt-8 text-yellow-400 font-bold text-lg">
